                ...
                <>
                    ...
                    <div className="d-flex justify-content-center">
                        <ul className="confirmacion">
                            ...
                            <li>
                                <span className="seat" style={{ background: '#2cef2c' }} /> <small>Confirmado</small>
                            </li>
                            <li>
                                <span className="seat" style={{ background: '#FFFF00' }} /> <small>Seleccionado</small>
                            </li>
                        </ul>
                    </div>
                    <div className="d-flex justify-content-center">
